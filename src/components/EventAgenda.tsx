...
const EventAgenda = () => {
  ...
  const day1Sessions = [
    ...
    },
    {
      ...
      title:
        'Keynote: Legal Leadership in the Age of Disruption: Challenges & Opportunities',
      description:
        "A compelling insight into how legal professionals can lead with agility amid rapid technological, regulatory, and societal changes shaping India's justice ecosystem.",
    },
    {
    ...
    },
    {
      ...
      description:
        'Refreshing hi-tea break with snacks and engaging conversations with fellow legal professionals.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Awardees will be honoured in with the Bharat Nyaya Purasakar - Presented by Indian Actor Sourabh Raaj Jain',
    },
    {
  ...
  const day2Sessions = [
    ...
    },
    {
      time: '9:45 AM - 10:00 AM',
      title:
        "Keynote Speech: Emerging Legal Frontiers - Navigating Industry Trends Shaping India's Regulatory Landscape",
      description:
        'An insightful exploration of evolving industry trends in India, and how legal frameworks are adapting to drive innovation, compliance, and sustainable growth.',
    },
    {
      time: '10:00 AM - 10:15 AM',
      title: 'Case Study Presentation',
    ...
    },
    {
      ...
      title:
        'Panel Discussion: Guardians of the Grid: Legal Strategies for Data Breaches, Ransomware, and Digital Espionage',
      description:
        'Exploring legal frameworks and response strategies to combat data breaches, ransomware attacks, and cyber espionage in a digital-first world.',
    },
    {
    ...
    },
    {
      ...
      title:
        'Panel Discussion: Intellectual Property in India: Protecting Innovation- Key strategies to secure and enforce IP rights in India',
      description:
        'Exploring how in-house counsels are increasingly shaping strategic business decisions and driving organizational value beyond traditional legal roles.',
    },
    {
      ...
      title:
        'Panel Discussion: Markets on the Edge: Tackling Anti-Competitive Conduct in the Platform Economy',
      description:
        'A deep dive into legal approaches to detect, regulate, and prevent anti-competitive behavior in the rapidly evolving platform-based digital economy.',
    },
    {
      time: '2:00 PM - 3:00 PM',
      title:
        'Panel Discussion: Turbulence in the Skies: Legal Accountability and Policy Reform After the Air India Crash',
      description:
        'Exploring legal accountability, regulatory challenges, and policy reforms in the wake of major aviation disasters.',
    },
    {
    ...
    },
    {
      time: '4:00 PM - 4:50 PM',
      title:
        'Panel Discussion: The Transformative Role of Al in Revolutionizing Legal Practice, Compliance, and Governance.',
      description:
        'Exploring how Al is reshaping legal practice, enhancing compliance, and driving smarter governance in the digital age.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Closing of the event followed by Refreshing networking-tea break with snacks & engaging conversations with fellow legal professionals.',
    },
  ];
