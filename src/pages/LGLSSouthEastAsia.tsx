...
import { agendaDetails, boardMembers, descriptionDetails, eventPartners, eventSpeakers, galleryImages, guestsOfHonour, heroSection, honourableGuests, keyHighlights, mediaPartners, supportLetterSection, videoHighlight, whatToExpect, upcomingEvents } from '../data/southeastasia';

function LGLSSouthEastAsia() {
  return (
...
export default LGLSSouthEastAsia;
